...
Kher, M. M. (2026). *QueryBee: a single-file, browser-based fielded Boolean query builder for literature search* (Version 1.2.2) [Computer software]. Zenodo. https://doi.org/10.5281/zenodo.20733036
